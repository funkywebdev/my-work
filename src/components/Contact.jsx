...
// const Contact = () => {
//   return (
//     <section id="Contact" className="px-6 md:px-16 py-10">
      
//       {/* Header */}
//       <div className="text-center text-[#001489] mb-10">
...
//       {/* Grid: Form + Info */}
//       <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-12 lg:px-24">
...
//             className="border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-[#001489]"
//           />
...
//             className="border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-[#001489]"
//           />
//             <p className="bg-[#001489] w-full text-white flex items-center justify-center gap-2 px-4 py-2 rounded cursor-pointer hover:opacity-90">
...
//         {/* Contact Info */}
//                 <div className="bg-[#001489] text-white rounded-md p-6 sm:p-8 md:p-12 w-full sm:w-max md:col-span-1 mx-auto md:mx-0 sm:h-max">
