...
//   return (
//     <header className="sticky top-0 z-50 bg-[#001489] shadow-md backdrop-blur-sm rounded-t-[20px]">
//       <nav className="flex items-center justify-between w-11/12 mx-auto py-5 rounded-t-lg">
      ...
      <nav className="flex items-center justify-between w-11/12 mx-auto py-5 rounded-t-lg">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <button
            ...
            className="ml-2 text-white text-2xl hover:text-red-300 transition"
            title="Logout"
          >
            <FiLogOut />
          </button>
