...
//     img: FrameA,
//     title: "Physics",
//     desc: "Physics explores matter, energy, and the forces that shape our universe.",
//   },
//   {
//     img: FrameB,
//     title: "Chemistry",
//     desc: "Chemistry studies substances, their properties, and the reactions that transform them.",
//   },
//   {
//     img: FrameC,
//     title: "Biology",
//     desc: "Biology examines living organisms, their structure, function, growth, and evolution.",
//   },
//   {
//     img: FrameD,
//     title: "Mathematics",
//     desc: "Mathematics focuses on numbers, quantities, patterns, and problem-solving methods.",
//   },
// ];

// const Stem = () => {
//   return (
//     <div className="px-4 py-8 sm:px-16 md:px-20 lg:px-24 font-poppins">
//       {/* Heading Section */}
//       <div className="mb-4 text-center ">
//         <p className="text-2xl font-bold sm:text-2xl">STEM Subjects</p>
//         <p className="mt-2 text-[16px] text-gray-600 sm:text-base md:text-lg font-semibold">
//           Test your knowledge across four core disciplines
//         </p>
//       </div>

//       {/* Subjects Grid */}
//       <div className="grid grid-cols-2 gap-2 sm:gap-8 sm:grid-cols-2 lg:grid-cols-4">
//         {subjects.map((subject, index) => (
//           <motion.div
//             key={index}
//             className="flex flex-col items-center p-6 text-center cursor-pointer rounded-xl"
...
//             />
//             <p className="mb-2 text-lg font-semibold sm:text-xl">{subject.title}</p>
//             <p className="text-sm text-gray-600 sm:text-base">{subject.desc}</p>
//           </motion.div>
//         ))}
//       </div>
//     </div>
