...
const Footer = () => {
  return (
    <footer className="bg-[#001489] text-white font-poppins relative pt-16 sm:pt-20">
      ...
      <div className="relative z-10 p-6 mx-4 -mt-10 bg-white shadow-lg rounded-2xl sm:mx-10 md:mx-16 lg:mx-24 sm:p-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start text-left">
          <div>
            ...
            <p className="mt-2 text-sm sm:text-base text-black">
              Subscribe to receive updates on competitions, events, and resources
              designed to help you grow in STEM
            </p>
          </div>

          <div className="flex flex-col sm:flex-row items-start gap-3 mt-4 sm:mt-0">
            <input
              type="email"
              placeholder="Enter your email"
              className="w-full sm:flex-1 px-4 py-3 text-sm rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#001489] text-black font-semibold"
      ...
      {/* Main Footer Content */}
      <div className="px-6 sm:px-10 md:px-16 py-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 text-left">
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#Sponsor" className="hover:text-gray-300 transition">
                  Our Sponsor
                </a>
              </li>
              <li>
                <a href="#About2" className="hover:text-gray-300 transition">
                  How it works
                </a>
              </li>
            </ul>
          ...
          {/* Policy & Privacy */}
          <div className="flex flex-col items-start">
            <h4 className="font-semibold mb-2">Policy & Privacy</h4>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <a href="#Question" className="hover:text-gray-300 transition">
                  FAQs
                </a>
              </li>
            </ul>
          ...
          {/* STEM Subjects */}
          <div className="flex flex-col items-start">
            <h4 className="font-semibold mb-2">STEM Subjects</h4>
            <ul className="space-y-2 text-sm">
              <li>Biology</li>
              <li>Chemistry</li>
              <li>Physics</li>
        ...
        {/* Footer Bottom */}
        <div className="pt-8 mt-10 text-xs sm:text-sm text-left sm:text-center border-t border-gray-700">
          © {new Date().getFullYear()}{" "}
          <span className="font-semibold">Bolo Quiz League</span>. All rights
          reserved.
        </div>
      </div>
    </footer>
